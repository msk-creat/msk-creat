...
class MainControl:
    ...
    def grab_ball_from_big_diameter(self) -> None:
        ...
        while (time.time() - start_time) < 10:
            ...
            if predict_result not in ['blue', 'yellow']:
                continue
    ...
    def turn_away_from_big_diameter_to_warehouse(self) -> None:
        ...
        self.movecontrol.rotate(angle=-720)
        self.movecontrol.advance()
        self.movecontrol.move_X(distance=1.8)
        self.movecontrol.rotate(angle=720)
    ...
    def go_back_to_diameter(self) -> None:
        ...
        self.movecontrol.rotate(angle=-690)
        self.movecontrol.advance()
        self.movecontrol.move_X(distance=1.86)
    ...
    def go_to_platform(self):
        ...
        self.movecontrol.move_X(distance=0.2)
        self.movecontrol.rotate(angle=-720)
        self.movecontrol.move_X(distance=0.5)

        self.movecontrol.rotate(angle=750)
        self.movecontrol.move_X(distance=0.9)
        self.movecontrol.move_X(distance=0.98)        
        self.movecontrol.rotate(angle=-720)
        self.movecontrol.highest()
        # self.movecontrol.move_X(distance=-0.1)
    ...
    def go_to_ware_house(self) -> None:
        ...
        self.movecontrol.rotate(angle=-1440)
        self.movecontrol.move_X(distance=1.2)
        self.movecontrol.move_Y(distance=-0.22)
        self.movecontrol.highest()
        self.adjust_angle_by_lines()
        ...
        self.movecontrol.rotate(angle=-720)
        self.movecontrol.move_X(distance=0.45)
        self.movecontrol.rotate(angle=-720)
        self.movecontrol.move_X(distance=-0.2)
    ...
    def go_home(self) -> None:
        ...
        self.movecontrol.move_X(distance=0.1)
        self.movecontrol.rotate(angle=720)
        self.movecontrol.move_X(distance=1.78)
        self.movecontrol.rotate(angle=-720)
        self.movecontrol.move_X(distance=0.05)
        self.movecontrol.advance()
    ...
    def start(self) -> None:
        ...
        self.movecontrol.move_Y(distance=-0.15)
        ...
        self.movecontrol.move_Y(distance=-0.13)
